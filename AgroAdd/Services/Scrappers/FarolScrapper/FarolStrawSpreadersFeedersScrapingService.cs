...
{
    public class FarolStrawSpreadersFeedersScrapingService : IScrapingService
    {
        ...
        public string ServiceName => "         *Straw Feeders Spreaders";
        ...
        public void ScrapAsync(string query, string synonyms, bool filtering, int? costmin, int? costmax, int page = 1)
        {
            ...
            {
                if (page < 2)
                    _scrapBrowser.Navigate($"https://www.farol.co.uk/product-list/straw-spreaders/PVRLMO833551");
                if (!_rateLoaded)
                {
